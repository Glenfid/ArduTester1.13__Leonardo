...
/* configure WITH_VEXT, TPext and TPex2  */
#if (PROCESSOR_TYP == 8) || (PROCESSOR_TYP == 168) || (PROCESSOR_TYP == 328) || (PROCESSOR_TYP == 32)
    ...
    /* TQFP_ADC6 is undefined */
      ...
      #warning "WITH_VEXT deselected, PF4 is used for UART"
...
#endif	/* PROCESSOR_TYP == 8|168|328|32 */
