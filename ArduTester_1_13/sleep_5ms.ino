...
while (pause > 0)
  {
   ...
   OCR0A = TCNT0 + t2_offset;	/* set the compare value */ //leonardo
   //TIMSK2 = (0<<OCIE2B) | (1<<OCIE2A) | (0<<TOIE2); /* enable output compare match A interrupt */ 
   TIMSK0 = (0<<OCIE0B) | (1<<OCIE0A) | (0<<TOIE0); /* enable output compare match A interrupt */ //leonardo
...
// wake up after output compare match interrupt
   //TIMSK2 = (0<<OCIE2B) | (0<<OCIE2A) | (0<<TOIE2); /* disable output compare match A interrupt */ 
    TIMSK0 = (0<<OCIE0B) | (0<<OCIE0A) | (0<<TOIE0); /* disable output compare match A interrupt *///leonardo
